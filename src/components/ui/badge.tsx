  ...
  "inline-flex items-center rounded-sm border px-3 py-1 text-xs font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
       ...
       outline: 
  "border-zinc-700 bg-transparent text-zinc-900 hover:bg-zinc-900 hover:text-zinc-100 dark:border-zinc-300 dark:bg-transparent dark:text-zinc-100 dark:hover:bg-zinc-50 dark:hover:text-zinc-900 text-[10px] px-2 py-0.5",
        subtle:
